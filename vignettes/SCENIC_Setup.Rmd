...
**AUCell>=1.2.4**, **RcisTarget>=1.0.2**, and **GENIE3>=1.2.1**.
...
install.packages("https://bioconductor.org/packages/release/bioc/src/contrib/GENIE3_1.4.0.tar.gz", repos=NULL)
```
