...
AUCell and RcisTarget were updated in May 2018 and Jan 2019. Please, make sure you have the recommended versions:
...
In case you have trobule installing the packages from Bioconductor (for example, if you don't have the newest version of R), you may try installing them from Github *or* directly from the Bioconductor package files:
