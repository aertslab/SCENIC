...
For tests (quick runs) we provide a toy example only 200 cells and <1000 genes:
```{r loadLoom}
loomPath <- system.file(package="SCENIC", "examples/mouseBrain_toy.loom")
...
This toy example is a subset of the 3005 cell mouse brain dataset described in the setup vignette:
```{r loadExprMat, eval=FALSE}
# TODO: Convert to loom
