...
**AUCell 1.2.2**, and **RcisTarget 1.0.2** or posterior.
...
Download the *.feather* files (and *.descr*, if available) for the relevant organism *(feel free to use any alternative download method)* [Aprox file size: 1GB]:
